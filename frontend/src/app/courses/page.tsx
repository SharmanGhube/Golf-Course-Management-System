...
import { MapPin, Star, DollarSign, Users, Clock, Target, ChevronDown, ChevronUp } from 'lucide-react'
...
export default function CoursesPage() {
  ...
  const handleViewDetails = (courseId: number) => {
    if (expandedCourse === courseId) {
      ...
      toast.success('Details collapsed')
    } else {
      setExpandedCourse(courseId) // Expand the clicked course
